...
beforeAll(async () => {
  ...
  await ctx.db.batch([
    ctx.db.prepare("INSERT INTO events (id, title, slug, start_at, published) VALUES (1, 'E', 'e', '2999-01-01 10:00:00', 1)"),
    ctx.db.prepare("INSERT INTO events (id, title, slug, start_at, published) VALUES (2, 'F', 'f', '2999-01-01 10:00:00', 1)"),
  ]);
  await ctx.db.batch([
