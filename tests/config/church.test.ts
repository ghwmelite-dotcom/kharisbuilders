...
describe('church config', () => {
  it('has identity, theme (4 hex), currency, tz, motifs, and 8 features', () => {
    ...
    expect(Object.keys(CHURCH.features).sort()).toEqual(['ai', 'blog', 'community', 'events', 'giving', 'live', 'ministries', 'sermons']);
  });
