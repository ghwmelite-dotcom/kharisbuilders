/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dd1faf1c6500b7f46013c6a1b251deca)
// Runtime types generated with workerd@1.20260601.1 2026-06-02 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	SESSION: KVNamespace;
	MEDIA: R2Bucket;
	DB: D1Database;
	SERMONS: VectorizeIndex;
	AI: Ai;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SECRET_KEY" | "DEV_ADMIN_EMAIL" | "PAYSTACK_SECRET_KEY">> {}
}
